...
> [!TIP]
> ### ☁️ 还没有 Nightscout？从云端到灯光，一起搭起来。
>
> 试试我的另一个开源项目 [Nightscout for Cloudflare](https://github.com/sid-luo/nightscout-for-cloudflare)：依托 Cloudflare，**几分钟就能部署好**，**完全免费（不用绑定信用卡）**，**数据全部由你自己掌握**，无需购买服务器或配置 MongoDB。搭好后，连接 Suger RGB，让血糖和走势出现在身边的灯光里。
>
> **[了解项目 →](https://github.com/sid-luo/nightscout-for-cloudflare)** · **[开始网页部署 →](https://nscf.sidluo.com)**
